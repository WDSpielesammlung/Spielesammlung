<script lang="ts">
  ...
  {#if pipePair.show }
  <div
    style="left: {pipePair.left}vw; top: {pipePair.topPipe.top}vh; width: {pipePair.width}vw; height: {pipePair.topPipe.height}vh;"
    class="pipeTop"
  ></div>
  <div
    style="left: {pipePair.left}vw; top: {pipePair.bottomPipe.top}vh; width: {pipePair.width}vw; height: {pipePair.bottomPipe.height}vh;"
    class="pipeBottom"
  ></div>
  {/if}