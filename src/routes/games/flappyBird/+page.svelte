...
<style>
	...
	.twinkleMask {
		background: transparent url('https://wolf.drjm.co.uk/nightsky/twinklemask.png') repeat top
			center;
		z-index: -9;
	...
	.twinkleMask2 {
		background: transparent url('https://wolf.drjm.co.uk/nightsky/twinkleMask2.png') repeat top
			center;
		z-index: -8;
		height: 100%;
	...
	.fog {
		...
		background: linear-gradient(
			-5deg,
			'#00000000 0%, #ffffff15 40%, #74590121 45%, #8b845b21 55%, #00000000 70%'
		);
	}
